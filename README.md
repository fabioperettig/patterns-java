...
*   **Original Scenarios:** Real-world problems solved through pattern application.
*   **Curated Learning:** Inspired by industry-standard resources like **RefactoringGuru** and **roadmap.sh**.

## 🛠️ Roadmap & Progress

The patterns are categorized into the three classic groups. This list is updated as the study progresses.
